        ...
        <div class="card shadow-sm mb-4 pt-4 pb-0" style="border-radius: 16px">
            ...
            <div class="card-body px-4">
                <form>
                    ...
                    <div class="mb-3">
                        <label for="confirmEmail" class="form-label fw-semibold">Confirmation Email <span
                                class="text-danger">*</span></label>
                    ...
                    <div class="mb-3">
                        <label for="fname" class="form-label fw-semibold">First Name <span
                                class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="fname" placeholder="Placeholder">
                    </div>
                    <div class="mb-3">
                        <label for="lname" class="form-label fw-semibold">Last Name <span
                                class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="lname" placeholder="Placeholder">
                    </div>
                    <div class="mb-3">
                        <label for="dob" class="form-label fw-semibold">Date of Birth <span
                                class="text-danger">*</span></label>
                    ...
                    <div class="mb-3">
                        <label for="ktp" class="form-label fw-semibold">KTP/Passport <span
                                class="text-danger">*</span></label>
            ...
            <div class="d-flex justify-content-between border-top border-2 px-4 py-3">
                <a href="#" class="btn btn-outline-secondary fw-medium px-4 d-flex align-items-center gap-2"
