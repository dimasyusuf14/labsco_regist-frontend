        ...
        <div class="card shadow-sm mb-4 pt-4 pb-0" style="border-radius: 16px">
                ...
                <form>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex gap-4">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="shirtType" id="shirtMen"
                                    value="men">
                                <label class="form-check-label" for="shirtMen">Men</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="shirtType" id="shirtWomen"
                                    value="women">
                    ...
                    <div id="sizeChartWrapper" class="mb-3 d-none">
                        <div class="mb-3 text-start">
                            ...
                            <a href="#" class="d-block mt-2 text-primary" style="font-size: 13px;"
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex gap-3">
                            <div>
                                ...
                                <input type="number" class="form-control" id="finishHour" placeholder="0"
                                    min="0">
                            </div>
                            <div>
                                <label for="finishMinute" class="form-label small">Minute</label>
                                <input type="number" class="form-control" id="finishMinute" placeholder="0"
                                    min="0" max="59">
                            </div>
                        </div>
                    </div>
            ...
            <div class="d-flex justify-content-between border-top border-2 px-4 py-3">
                <a href="{{ route('registration-two') }}"
                    ...
                    <img src="{{ asset('assets/icons/ic-arrow-back.svg') }}" alt="Back"
                        style="width:13px;height:11px;">
                    Back
                </a>
                <a href="{{ route('data-confirmation') }}"
                    class="btn btn-primary fw-medium px-4 d-flex align-items-center gap-2" style="font-size: 16px;">
                    Next
                    <img src="{{ asset('assets/icons/ic-arrow-next.svg') }}" alt="Next"
                        style="width:13px;height:11px;">
                </a>
            </div>
        </div>
